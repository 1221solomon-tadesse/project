          ...
          <div
            ...
            <div className="hidden md:ml-6 md:block">
              <div className="flex space-x-2">
                <Link href="/"
                  className={`${pathname==='/'? 'bg-black':''}text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2`}>Home</Link>
          ...
          <div
            ...
            <div className="relative ml-3">
             ...
             <div
                ...
                <Link
                  href="/profile"
                  className={`${pathname==='/profile'?'bg-black':''}hover:bg-gray-900 block px-4 py-2 text-sm text-gray-700`}
                  role="menuitem"
                  tabIndex="-1"
                  id="user-menu-item-0"
                  >Your Profile</Link>
                <Link
                  ...
                  className={`${pathname==='/properties/saved'?'bg-black':''}hover:bg-gray-900 block px-4 py-2 text-sm text-gray-700`}
                  role="menuitem"
                  tabIndex="-1"
                  id="user-menu-item-2"
                  >Saved Properties</Link>
                <button
                  className={`${pathname==='/signout'?'bg-black':''}hover:bg-gray-900 block px-4 py-2 text-sm text-gray-700`}
                  role="menuitem"
                  tabIndex="-1"
                  id="user-menu-item-2"
                  >Sign Out</button>
